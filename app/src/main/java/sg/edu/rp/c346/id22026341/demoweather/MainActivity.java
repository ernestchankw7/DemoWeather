package sg.edu.rp.c346.id22026341.demoweather;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, alWeather);
    }
    ...
    protected void onResume() {
        ...
        client.get("https://api.data.gov.sg/v1/environment/2-hour-weather-forecast", new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                adapter = new ArrayAdapter<Weather>(MainActivity.this, android.R.layout.simple_list_item_1, alWeather);
